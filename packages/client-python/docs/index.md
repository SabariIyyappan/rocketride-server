...
- **Telemetry taxonomy** - Shared, zero-runtime PostHog event names and property types via `rocketride.analytics` ([Analytics / Telemetry Taxonomy](/develop/python/analytics))
